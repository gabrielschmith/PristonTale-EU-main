...
int UnitGame::iMainStatModifier = 0;
int UnitGame::iLowestEfficiency = 0;
int UnitGame::iMaxEfficiency = 0;
int UnitGame::iStatsToMaxEfficiency = 0;
int UnitGame::iLevelOverride = 0;
